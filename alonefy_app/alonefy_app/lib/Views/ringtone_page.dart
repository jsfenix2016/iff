...
class _RingTonePageState extends State<RingTonePage> with WidgetsBindingObserver {
    ...
    showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            ...
            content: Text("El sonido para la notificación se ha guardado correctamente."),
            actions: <Widget>[
              TextButton(
                child: const Text("Ok"),
                onPressed: () => Navigator.of(context).pop(),
